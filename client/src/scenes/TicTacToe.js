...
class TicTacToe extends Phaser.Scene {
  ...
  create() {
    ...
    this.graphics = this.add.graphics({
      lineStyle: { width: 4, color: 0x000000 },
    });
    ...
    const createX = (location) => {
      
    }
    const createO = (location) => {
  ...
  update() {
    ...
    if (!this.grid.animComplete) {
      ...
      this.grid.lineY1.drawing = false;
      this.grid.lineY2.drawing = false;
      this.grid.lineX1.drawing = false;
